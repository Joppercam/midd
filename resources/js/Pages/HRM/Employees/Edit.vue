          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div v-if="form.status === 'terminated'">
                  <label for="termination_date" class="block text-sm font-medium text-gray-700">Fecha de Término</label>
                  <input
                    id="termination_date"
...
const submit = () => {
  ...
  form.put(route('hrm.employees.update', props.employee), {
    preserveScroll: true,
    onSuccess: () => {
