<template>
    <SuperAdminLayout>
        ...
        <div class="space-y-6">
            <!-- Page Header -->
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Crear Plan de Suscripción</h1>
                <p class="text-gray-600">Define un nuevo plan de suscripción para empresas</p>
            </div>
...
const submit = () => {
    form.post(route('super-admin.subscriptions.plans.store'))
}
</script>