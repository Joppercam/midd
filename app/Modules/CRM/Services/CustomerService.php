...
class CustomerService
{
    ...
    public function createCustomer(array $data): Customer
    {
        ...
        // Verificar RUT �nico dentro del tenant
        ...
        // Configurar categor�a por defecto basada en el l�mite de cr�dito
        if (empty($data['category'])) {
            $data['category'] = $this->determineCategoryByRevenue($data['credit_limit'] ?? 0);
        }

        // Reemplazar RUT con versi�n limpia
        $data['rut'] = $cleanRut;
    ...
    public function importCustomers(File $file, bool $updateExisting = false): array
    {
        ...
        // Por ahora retornar un mensaje de �xito
        return [
            'success' => true,
    ...
    public function mergeCustomers(int $sourceId, int $targetId): array
    {
        ...
        DB::transaction(function () use ($source, $target) {
            ...
            // Combinar informaci�n si est� vac�a en el target
            $updateData = [];
    ...
    public function addCustomerNote(Customer $customer, string $note, string $type = 'general'): array
    {
        ...
        // En una implementaci�n completa, esto ser�a un modelo separado
        return [
            'id' => uniqid(),
    ...
    {
        // Implementar l�gica para obtener historial de contacto
