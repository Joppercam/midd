...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        $rolesWithStats = $roles->map(function ($role) {
            return [
                ...
                'is_system' => in_array($role->name, ['super-admin', 'admin', 'accountant', 'sales', 'viewer']),
            ];
        });
    ...
    public function edit(Role $role)
    {
        ...
        $systemRoles = ['super-admin', 'admin', 'accountant', 'sales', 'viewer'];
        if (in_array($role->name, $systemRoles)) {
            return back()->with('error', 'Los roles del sistema no pueden ser editados.');
        }
