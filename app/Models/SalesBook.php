...
class SalesBook extends Model
{
    ...
    /**
     * Get the entries for the sales book.
     */
    public function entries(): HasMany
    {
        return $this->hasMany(SalesBookEntry::class);
    }
    ...
    public function calculateTotals(): void
    {
        ...
        // Calculate credit and debit notes
        $creditNotes = $this->entries()
            ->where('status', 'active')
            ->where('document_type', 'credit_note')
            ->sum('total_amount');

        $debitNotes = $this->entries()
            ->where('status', 'active')
